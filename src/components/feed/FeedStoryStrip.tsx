    ...
    <>
      <section className="rounded-[28px] border border-[rgba(196,135,58,0.14)] bg-[rgba(255,250,245,0.96)] p-4 shadow-[0_18px_45px_rgba(196,135,58,0.09)]">
        ...
        <div className="flex gap-3 overflow-x-auto pb-1 scrollbar-none">
          ...
          >
            <div 
              className={`relative mb-2 flex h-[74px] w-[74px] items-center justify-center rounded-full p-[3px] transition duration-200 group-hover:scale-[1.03] ${
                currentUserGroup 
            ...
            <div className="w-full truncate text-xs font-semibold text-[var(--color-navy)]">
              Your story
            </div>
