    ...
    <>
      {c.viewingImageMsg && (
        <div className="fixed inset-0 z-[100] flex flex-col bg-black/95 animate-in fade-in duration-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  link.download = `lumina_image_${c.viewingImageMsg.id}.jpg`;
          ...
          <div className="flex-1 overflow-hidden flex items-center justify-center p-4 cursor-zoom-out" onClick={() => c.setViewingImageMsg(null)} style={{ WebkitTapHighlightColor: 'transparent' }}>
            <img src={c.viewingImageMsg.image_url} alt="Fullscreen view" draggable={false} className="max-w-full max-h-full object-contain drop-shadow-2xl animate-in zoom-in-95 duration-200 select-none outline-none" onClick={(e) => e.stopPropagation()} />
          </div>
